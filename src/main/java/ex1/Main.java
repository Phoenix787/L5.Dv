...
public class Main {
    ...
    /**
     * Статический вложенный класс. Его проще создавать и к нему проще обращаться (Test.NoName3 noname3 = new Test.NoName3();)
     */
    ...
    public static void main(String[] args) {
        ...
        /*
        Чтобы создать объект класса вложенного нестатического нужно сначала создать экземляр класса Test (главного класса)
